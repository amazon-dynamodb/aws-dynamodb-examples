...
/**
 * Runs the same smoke tests as {@link ProgressionSmokeTest} with {@code dynamodb.client-type=low-level}.
 *
 ...
 */
@Tag("smoke")
class ProgressionLowLevelSmokeTest extends ProgressionSmokeTest {

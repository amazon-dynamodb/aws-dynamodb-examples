...
/**
 * Runs {@link PlayerControllerIntegrationTest} with {@code dynamodb.client-type=low-level}.
 *
 * <p>Verifies the low-level {@link LowLevelDynamoDbPlayerStateRepository} path for registration
 * and profile reads end to end.
 *
 * <p>Runs against DynamoDB Local via Testcontainers with a full Spring context.
 */
@Tag("integration")
class PlayerControllerLowLevelIntegrationTest extends PlayerControllerIntegrationTest {

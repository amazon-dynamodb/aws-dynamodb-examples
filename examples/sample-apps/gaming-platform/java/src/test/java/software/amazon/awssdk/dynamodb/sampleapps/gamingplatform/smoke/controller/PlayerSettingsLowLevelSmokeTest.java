...
/**
 * Runs the same smoke tests as {@link PlayerSettingsSmokeTest} with {@code dynamodb.client-type=low-level}.
 *
 ...
 */
@Tag("smoke")
class PlayerSettingsLowLevelSmokeTest extends PlayerSettingsSmokeTest {

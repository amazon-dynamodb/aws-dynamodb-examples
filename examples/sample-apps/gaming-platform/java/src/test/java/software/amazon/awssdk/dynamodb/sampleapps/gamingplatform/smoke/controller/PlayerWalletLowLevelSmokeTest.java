...
/**
 * Runs the same smoke tests as {@link PlayerWalletSmokeTest} with {@code dynamodb.client-type=low-level}.
 *
 ...
 */
@Tag("smoke")
class PlayerWalletLowLevelSmokeTest extends PlayerWalletSmokeTest {

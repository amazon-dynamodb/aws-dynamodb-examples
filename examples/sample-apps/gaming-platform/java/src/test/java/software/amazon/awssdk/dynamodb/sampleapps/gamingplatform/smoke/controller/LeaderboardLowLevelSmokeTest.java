...
/**
 * Runs the same smoke tests as {@link LeaderboardSmokeTest} with {@code dynamodb.client-type=low-level}.
 *
 ...
 */
@Tag("smoke")
class LeaderboardLowLevelSmokeTest extends LeaderboardSmokeTest {

...
/**
 * Runs {@link PlayerSettingsIntegrationTest} with {@code dynamodb.client-type=low-level}.
 *
 * <p>Verifies the low-level {@link LowLevelDynamoDbPlayerStateRepository} path for settings reads
 * and optimistic updates end to end.
 *
 * <p>Runs against DynamoDB Local via Testcontainers with a full Spring context.
 */
@Tag("integration")
class PlayerSettingsLowLevelIntegrationTest extends PlayerSettingsIntegrationTest {

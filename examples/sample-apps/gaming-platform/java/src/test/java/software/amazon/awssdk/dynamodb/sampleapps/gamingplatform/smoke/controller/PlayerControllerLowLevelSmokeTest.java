...
/**
 * Runs the same smoke tests as {@link PlayerControllerSmokeTest} with {@code dynamodb.client-type=low-level}.
 *
 ...
 */
@Tag("smoke")
class PlayerControllerLowLevelSmokeTest extends PlayerControllerSmokeTest {

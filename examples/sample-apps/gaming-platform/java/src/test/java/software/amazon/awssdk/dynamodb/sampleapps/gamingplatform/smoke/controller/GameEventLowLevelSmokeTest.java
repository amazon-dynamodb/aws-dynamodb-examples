...
/**
 * Runs the same smoke tests as {@link GameEventSmokeTest} with {@code dynamodb.client-type=low-level}.
 *
 ...
 */
@Tag("smoke")
class GameEventLowLevelSmokeTest extends GameEventSmokeTest {

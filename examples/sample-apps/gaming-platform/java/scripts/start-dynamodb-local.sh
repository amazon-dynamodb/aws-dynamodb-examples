...
#
# DynamoDB Local will be accessible at http://localhost:8000.
# The script waits until the endpoint responds before returning.
# If startup times out, the script prints recent container logs and exits non-zero.

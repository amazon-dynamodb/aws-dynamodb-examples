...
#   Spring profile "test" is active; before each test method the table is deleted,
#   recreated (with DynamoDB Streams), and re-seeded from SeedAccountsData (same as app startup).
#   See DynamoDbTableTestReset.

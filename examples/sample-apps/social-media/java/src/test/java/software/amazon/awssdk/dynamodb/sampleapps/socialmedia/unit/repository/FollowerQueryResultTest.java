 ...
 *
 * <p>A truncated result with returned followers emits one {@code WARN} with the followee id, count,
 * and cap. A complete result is silent. An empty incomplete result is silent because the rate limiter
 * already logged the skipped Query.
 */
@Tag("unit")
...
class FollowerQueryResultTest {
    ...
    @Test
    void warnIfTruncated_whenEmptyIncomplete_doesNotLog() {
        FollowerQueryResult result = new FollowerQueryResult(List.of(), false, 2);

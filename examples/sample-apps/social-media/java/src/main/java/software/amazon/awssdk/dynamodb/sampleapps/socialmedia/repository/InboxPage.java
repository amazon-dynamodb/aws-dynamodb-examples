 ...
 * the inbox owner plus each branch as {@code START}, {@code AFTER_KEY}, or {@code EXHAUSTED}, so a
 * drained branch does not restart and a token minted for another user is rejected. It is
 * {@code null} only when both branches are exhausted.
 *

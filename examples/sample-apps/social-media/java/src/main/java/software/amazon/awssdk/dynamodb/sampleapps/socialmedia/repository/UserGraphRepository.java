...
public interface UserGraphRepository {
     ...
     * and later followers are not read. Repeated calls are also bounded by
     * {@code dynamodb.follower-enumeration-permits-per-second}. When that rate is exceeded the Query
     * is skipped and the result is empty and incomplete.
     *

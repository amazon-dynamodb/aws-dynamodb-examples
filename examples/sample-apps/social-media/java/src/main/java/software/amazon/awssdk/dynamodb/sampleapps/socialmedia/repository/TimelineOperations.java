    ...
    static CompletableFuture<TimelinePage> queryTimeline(DynamoDbAsyncClient client,
        ...
        if (exclusiveStartKey != null) {
            ...
            PaginationTokenCodec.requireMatchingStringAttribute(
                    exclusiveStartKey, DynamoDbSchema.TIMELINE_USER_ID, userId, nextToken);
        ...
        return GsiPageReader.queryPage(client, builder.build()).thenApply(page -> {
            ...
            return new TimelinePage(items, PaginationTokenCodec.encode(page.lastEvaluatedKey(), previousDepth));
        });
    }
}

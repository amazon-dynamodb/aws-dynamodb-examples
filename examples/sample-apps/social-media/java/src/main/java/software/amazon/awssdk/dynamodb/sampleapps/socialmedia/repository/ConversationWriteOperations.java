 ...
 *
 * <p>Create uses sequential {@code TransactWriteItems} chunks because DynamoDB caps one transaction
 * at 100 items. The first chunk is metadata plus up to 99 participants. Later chunks hold up to 100
 * participants. Repair uses the same 100-item participant bound. Inbox fan-out stays on 25-item
